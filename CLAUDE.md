...
- `voucher-settlement/` — 교환권 정산 대사(검증) 정적 웹앱. 빌드 도구 없이 파일을 그대로 서빙.
  ...
  - **높이는 인쇄 폭(CSS 약 703px)에서 재야 한다.** 화면 폭에서 재면 실제보다 짧게 나온다. 인쇄 가능 높이는 A4 12mm 여백 기준 약 1,032px, **Letter 용지면 약 964px**이다. 프린터가 Letter 로 맞춰져 있을 수 있으므로 **한 장을 900px 안쪽**으로 잡는다. 지금 1장 860px·2장 653px·3장 533~602px. **머리글·바닥글까지 켜져 있으면 900px 아래로 내려가므로** 한 장을 850px 안팎으로 잡는다.
